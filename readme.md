...
<h1> Circuit - Browser Extension</h1>
<h2>Enhanced Productivity & Workflow Automation</h2>

<h5>
Circuit is a powerful browser extension designed to streamline your workflow and enhance productivity. 
Built with modern web technologies including React, TypeScript, and TailwindCSS.
</h5>

<h5>Circuit empowers users to create efficient workflows and automate repetitive tasks in their browser environment. 🚀</h5>
...
Circuit is a comprehensive browser extension designed to enhance productivity and streamline workflows. Built with modern web technologies including React, TypeScript, and Tailwind CSS.

Circuit includes all essential extension pages such as **new tab**, **dev panel**, **popup**, **options**, and **content scripts**, with corresponding manifest settings configured for optimal performance.

The extension supports both Chrome and Firefox with manifest v3 compatibility.

Circuit leverages modern browser APIs and provides a robust foundation for building productivity-focused extensions with seamless local storage integration.
...
- [Github Action](https://github.com/amaan/circuit/actions/workflows/ci.yml) to build and zip Circuit extension (manual trigger)
...
Circuit comes with build configs for both Chrome and Firefox. Running
...
3. Run `yarn dev[:chrome|:firefox]`, or `npm run dev[:chrome|:firefox]`
...
Circuit includes source code for **all** of the extension pages (i.e. New Tab, Dev Tools, Popup, Side Panel
etc.). You can customize these pages to fit your specific workflow needs.

E.g. you don't want the newtab page to activate whenever you open a new tab:
1. remove the directory `newtab` and its contents in `src/pages`
2. remove `chrome_url_overrides: { newtab: 'src/pages/newtab/index.html' },` in `manifest.json`

Some pages like the "Side Panel" don't work the exact same in Chrome and Firefox. While Circuit includes
...
Circuit includes a directory `locales` with a basic setup for english i18n. Enabling i18n
...
### Publish Circuit to the Chrome Web Store<a name="publish"></a>
To upload Circuit to the Chrome Web Store, you need to pack (zip) it and then upload it to your item 
in the Chrome Web Store.

This repository includes a Github Action Workflow to create an 
optimized production build and zip file for distribution.
...
5. In the summary page **"Artifacts"** section click on the generated **"circuit-extension-chrome"**
